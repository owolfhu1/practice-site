...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _c1 = function _c1() {
      return ["/under-construction/elements"];
    };
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function AppComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          var _r51 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](12);

          var _r52 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](26);

          var _r53 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](31);
    ...
    function () {
      function HomeComponent(router) {
        ...
        this.seleniumItems = [{
          name: 'Elements',
          icon: 'dashboard',
          path: 'under-construction/elements'
        }, {
          name: 'Testing',
          icon: 'task_alt',
                  ...
                  case 5:
                    ...
                    if (data.results) {
                      data.results.forEach(function (item) {
                        if (!_this.carData[item.Year + '']) {
                          _this.carData[item.Year + ''] = {};
                          _this.carData[item.Year + ''][item.Make] = [item.Model];
                        } else {
                          if (!_this.carData[item.Year + ''][item.Make]) {
                            _this.carData[item.Year + ''][item.Make] = [item.Model];
                          } else {
                            _this.carData[item.Year + ''][item.Make].push(item.Model);
                          }
                        }
                      });
                    } else {
